...
int main(){
	...
	for(int i=0;i<500000;i++) {
		dl.insert(100+i%47 - (i%10001)/251.1 - .000001*i, 100 - i%91 + i%13 + .0001*i);
		//cout << i << endl;
	}
	...
	for(int i=0;i<500000;i++) {
		//cout << i << endl;
		dl.insert(50 - .00001*i, 10+ .0001*i);
	}
	...
	dl.out(10,'d');	
	endTime = clock();
	cout << "The sort time is: " <<((double)(endTime - startTime) / CLOCKS_PER_SEC) << "s" << endl;
	return 0;
}
