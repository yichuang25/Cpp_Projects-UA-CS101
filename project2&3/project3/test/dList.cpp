...
class dList {
     ...
     *  frontRef Node* reference pointer that will point to the head of first sorted half
     *  backRef Node* reference pointer that will point to the head of second sorted half
     */
...
char determine (Node *ptr) { // D:Dominated G:Dominating N:None
    if(ptr->prev == NULL) { //head 
        ...
        if(ptr->time == ptr->next->time) {
            ...
            else if (ptr->fuel == ptr->next->fuel) {
                return 'N';
            }
            else {
                return 'D';
        ...
        if(ptr->time == ptr->prev->time) {
            ...
            else if (ptr->fuel == ptr->prev->fuel) {
                return 'N';
            }
            else {
                return 'D';
